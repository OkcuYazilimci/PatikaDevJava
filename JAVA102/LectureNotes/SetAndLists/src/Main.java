...
public class Main {
    ...
    System.out.println("##################");
        ...
        Iterator<String> itr = listt.iterator();
        while (itr.hasNext()){
            System.out.println(itr.next());
        } */
    ...
    System.out.println("##################");
     */
        PriorityQueue<Student> q = new PriorityQueue<>(new OrderNoteComparator().reversed());
        q.add(new Student("Berke" , 90));
        q.add(new Student("Umut", 100));
        q.add(new Student("Umut", 50));
        q.add(new Student("Mehmet", 90));
